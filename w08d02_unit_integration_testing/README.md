...
## Types of testing
- unit: testing the small pieces of our code (functions)
- integration: testing how pieces work together
- end-to-end: testing the features of our application
- static: testing to see if our code is syntactically complete (linters)\
- regression: set-up test for a found bug, and keep those test for future iterations of our app
